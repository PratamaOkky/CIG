...
<div class="container">
    <div class="row">
        ...
        <div class="col-6"style="color:#BB1D33; padding-top: 200px;
                        text-align: left; font-family: Poppins; font-size: 35px; width: 500px">Sejarah
...
<div class="container">
    <div class="row">
        ...
        <img src="{{asset('assets/images/ic-struktur.png')}}"style="width: 85px;
height: 103px;
left: 155px;
top: 548px;">  
        </div>
        <div class="col-11"style="color:#BB1D33; padding-top: 175px;
                        text-align: left; font-family: Poppins; font-size: 35px; width: 500px">Struktur Organisasi
        </div>
    </div>
</div>
...
<div class="container"><center>
    ...
    <div class="col-1"></div>
        ...
        <div class="col-1"></div>
            ...
            <center><p style="padding-top: 10px;font-family: Poppins; font-size: 35px; width: 500px">Visi Misi
