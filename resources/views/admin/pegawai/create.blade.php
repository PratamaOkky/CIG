    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" style="margin-left: 25%" id="exampleModalLabel">Tambah Data Pegawai</h5>
            ...
            <div class="modal-body">
                <form action="{{route('pegawai.store')}}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="dt form-control @error('tgl_masuk') is-invalid @enderror" data-date-format="DD/MMM/YYYY" id="tgl_masuk" name="tgl_masuk" value="{{ old('tgl_masuk') }}">
                        @error('tgl_masuk')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
