    ...
    <div class="container">
        <div class="row">
            <div class=col-md-8 py-5>
                <div style="color:#BB1D33; padding-top: 200px; text-align: left; font-family: Poppins; font-weight: 700; font-size: 35px; width: 500px">Garda Mitra Nasional
                    <p style="font-size:14px; font-weight: 400;color:#350106">
                        Badan Usaha Jasa Pengamanan (BUJP) dan didirikan pada tanggal 5 November 2010.
                ...
                <a href="#" class="btn btn-danger ml-auto">Lebih Detail ► </a>
            </div>
...
<div class="container">
    <div class="row">
        <div class=col-md-8 py-5>
            <div style="color:#BB1D33; padding-top: 100px; text-align: left; font-family: Poppins; font-size: 35px; width: 500px">Terima Kasih Atas Kepercayaannya
                <p style="font-size:14px; color:#350106">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum, tristique ut nisl, accumsan nunc, condimentum bibendum mattis consectetur.</p>
            </div>
        </div>
