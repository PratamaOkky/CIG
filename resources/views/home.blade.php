        ...
        <div class="row">
            <div class=col-md-8 py-5>
                ...
                <!-- button lannjut -->
                    ...
                    <!-- cobain --> 
                    <a href="{{route('login')}}" class="btn1 btn-danger">Lebih Detail ► </a>&emsp;&emsp;
...
<div class="container" style="font-family: Poppins;">
        <div class="row g-0">
            ...
            <div class="col-md-3">
            <h5 class="mb-4" style="font-size: 14px;line-height: 21px;">Melakukan koordinasi secara rutin degan apparat managemen dan warga setempat</h5>
            </div>
            <div class="col-md-3">
            <h5 class="mb-4" style="font-size: 14px;line-height: 21px;">Menjalankan fungsi pengamanan dan pelayanan serta melaksanakan SOP, PSO dan Protap secara Konsisten serta melakuka evaluasi dan sharing knowladge</h5>
            </div>
            <div class="col-md-3">
            <h5 class="mb-4" style="font-size: 14px;line-height: 21px;">Melakukan Pengawasan secara berjenjang dan berkelanjutan terhadap pelaksanaan tugas personel di lokasi penjagaan</h5>
            </div>
            <div class="col-md-3">
            <h5 class="mb-4" style="font-size: 14px;line-height: 21px;">Melakukan pemeliharaan dan peningkatan kemampuan secara berlanjut serta selalu mengikuti perkembangan sesuai kebutuhan</h5>
            </div>
        </div>
</div>
